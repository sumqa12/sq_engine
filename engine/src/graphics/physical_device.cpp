...
namespace sq::graphics {
    ...
    VkFormat PhysicalDeviceSelector::find_depth_format(VkPhysicalDevice physical_device) {
        for (std::vector formats = {VK_FORMAT_D32_SFLOAT, VK_FORMAT_D32_SFLOAT_S8_UINT, VK_FORMAT_D24_UNORM_S8_UINT}; const auto& format : formats) {
        ...
        throw std::runtime_error("使用可能な深度フォーマットが見つかりません。");
    }
